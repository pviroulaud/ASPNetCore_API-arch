...
{
    public class RabbitMQErrorSubscriber : BackgroundService
    {
        private readonly IConfiguration _configuration;
        private string _exchangeName = "errorLog";
        ...
        public RabbitMQErrorSubscriber(IConfiguration configuration,
